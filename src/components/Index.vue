          ...
          <div class="form-container">
            ...
            <div class="bg-red">
              ...
              <q-card style=" width: 120%;">
                <q-card-actions class="bg-blue" align="between">
                  <div class="">
              ...
              <div v-for="(question, index) in questions" :key="question.id">
                <q-card class="" style=" width: 120%;">
                  <q-card-actions class="bg-orange" align="between">
                    <div class="">
                      <div
                        class="col bg-grey-3 "
                  ...
                  <q-card-actions align="between">
                    <div>
                      <q-item-label class="text-black"
                        >Jatuh Tempo</q-item-label
                      >
                      <span class="text-h6 text-bold text-black">tanggal</span>
                    </div>
                    <div class="q-pt-sm">
                      <div class="text-center q-gutter-sm">
                        <q-btn
                          to="/invoice"
                          label="regenerate"
                          class="text-caption text-white bg-black"
                        />
                        <q-btn
                          to="/invoice"
                          label="MCQ"
              ...
              <div>
                <q-btn label="back" @click="backClick" color="primary" />
              </div>
            </div>
          </div>
        </div>
